...
- global Activity menu that combines recent activity across displayed repositories
...
Use **Activity** from the tray menu to scan recent activity across displayed repositories. Repository submenus still keep their own per-repository Activity feeds.
